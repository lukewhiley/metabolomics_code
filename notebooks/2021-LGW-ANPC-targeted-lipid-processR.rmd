...
# Source R script from Github
summed-SIL-checkR_script <- GET(url = "https://raw.githubusercontent.com/lukewhiley/metabolomics_code/main/scripts/2021-LGW-lipidomics_summed_SIL_checkR.r") %>% content(as = "text")
