...
# Source R script from Github
LTR_SIL_checkR_script <- GET(url = "https://raw.githubusercontent.com/lukewhiley/metabolomics_code/main/scripts/2021-LGW-lipidomics-LTR_checkR_script.R") %>% content(as = "text")
