...
This chunk produces boxplots for each metabolite AREA for LTR
...
#start to build boxplot
      master_list$plots$area[[idx_analyte]] <- ggplot(data=master_list$data$flipped_all_plates$area %>% 
        ...
        print(master_list$plots$area[[idx_analyte]])
        
      }

```

This chunk produces boxplots for each metabolite AREA for SAMPLES


```{r boxplot SAMPLES metabolites by area}
...
This chunk produces boxplots for each metabolite CONCENTRATION for LTR
...
#start to build boxplot
      master_list$plots$conc[[idx_analyte]] <- ggplot(data=master_list$data$flipped_all_plates$conc %>% 
        ...
        labs(x = paste("plate"), y = paste("conc")) +
         ggtitle(paste0(idx_analyte, " - SAMPLES CONC")) +
        theme_bw() + 
        theme(plot.title = element_text(hjust = 0.5)) + 
        theme(plot.title = element_text(size=5)) +  
        theme(axis.text.y = element_text(size = 5, margin = margin(t = 0, r = 0, b = 0, l = 2))) +  
        ...
        print(master_list$plots$conc[[idx_analyte]])
        
      }

```

This chunk produces boxplots for each metabolite CONCENTRATION for SAMPLES


```{r boxplot samples metabolites by conc}
...
#start to build boxplot
      master_list$plots$conc[[idx_analyte]] <- ggplot(data=master_list$data$flipped_all_plates$conc %>% 
        ...
        geom_jitter(aes(), 
                  ...
                  shape = 21) +
        labs(x = paste("plate"), y = paste("conc")) +
         ggtitle(paste0(idx_analyte, " - LTR CONC")) +
        theme_bw() + 
        theme(plot.title = element_text(hjust = 0.5)) + 
        theme(plot.title = element_text(size=5)) +  
        theme(axis.text.y = element_text(size = 5, margin = margin(t = 0, r = 0, b = 0, l = 2))) +  
