...
report_script <- GET("https://raw.githubusercontent.com/lukewhiley/metabolomics_code/main/ANPC_lipidomics_tools/notebooks/2021-LGW-Lipid_ExploreR_QC_Report.Rmd") %>% content(as = "text")
...
loading PCA - make markers 0.5 opacity, grey and black line outer
change plotly colours to match throughout
plotly line markers - change to median
report from github not local file
