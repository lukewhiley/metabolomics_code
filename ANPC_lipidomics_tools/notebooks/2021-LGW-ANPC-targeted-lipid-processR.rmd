...
# TIC check
summed_TIC_checkR_script <- GET(url = "https://raw.githubusercontent.com/lukewhiley/metabolomics_code/main/ANPC_lipidomics_tools/scripts/2021-LGW-lipidomics-summed_TIC_checkR_script.R") %>% content(as = "text")
...
# Source R script from Github
LTR_SIL_checkR_script <- GET(url = "https://raw.githubusercontent.com/lukewhiley/metabolomics_code/main/ANPC_lipidomics_tools/scripts/2021-LGW-lipidomics-PCA_QC_checkR_script.r") %>% content(as = "text")
eval(parse(text = LTR_SIL_checkR_script), envir = .GlobalEnv)
...
#notes
SILS are being kept in the data - check to see why.
add a SIL check (indvidual SIL in case a SIL isn't present)
...
plate boundaries on one of the plots
report export
