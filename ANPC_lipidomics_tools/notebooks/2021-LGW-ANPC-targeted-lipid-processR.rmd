...
fileConn<-file(paste(project_dir, "/html_files/ANPC_lipidomics-report-generatoR.r", sep=""))
...
rmarkdown::render(input = paste(project_dir, "/html_files/ANPC_lipidomics-report-generatoR.r", sep=""),
...
file.remove(paste(project_dir, "/html_files/ANPC_lipidomics-report-generatoR.r", sep=""))

browseURL(paste(project_dir, "/html_files/",project_name, "_", user_name, "_lipid_exploreR_QC_report.html", sep="")) #open plotly widget in internet browser
